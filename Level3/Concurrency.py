"""
Concurrency, CPU Bound vs I/O Bound - Concurrency?
Keyword - Concurrency
...
- CPU 가용성 극대화 위해 Paralleism의 단점 및 어려움을 소프트웨어(구현)래벨에서 해결하기 위한 방법
...
동시성 : 논리적, 동시 실행 패턴(논리적), 싱글코어, 멀티 코어에서 실행 가능, 한개의 작업에서 공유 처리, 디버깅 매우 어려움, Mutex, Dead Lock
